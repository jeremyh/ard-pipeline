...
snow/ice classification), contiguous observations within band stack mask, and MGRS tile
mask creation code supporting Sentinel-2 Level 1 C SAFE format zip archives hosted by the
