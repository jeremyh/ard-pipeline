...
def get_water_vapour_data(l1t_input_dataset, DIR_WaterVapour, DEBUG):
    water_vapour_dataset = WaterVapourDataset(
        DIR_WaterVapour, l1t_input_dataset.scene_centre_datetime
    )
    water_vapour_value = water_vapour_dataset.get_data_value(
        l1t_input_dataset.lonlats["CENTRE"]
    )
