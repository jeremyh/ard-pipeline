...
def unmix(landsatReflectance):
    ...
    for tile in tiles:
        ...
        weightedSpectra = numpy.zeros(
            (interactiveTerms.shape[0] + 1,) + interactiveTerms.shape[1:]
        )
        ...
        fractions[:, ystart:yend, xstart:xend] = unmiximage.unmiximage(
            weightedSpectra, endmembers_array, inNullValDN, outUnmixNullVal
        )  # The fortan method
