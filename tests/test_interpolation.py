...
from wagl.interpolation import bilinear, interpolate_block, interpolate_grid, subdivide
...
class TestInterpolateBlock(unittest.TestCase):
    def test_interpolate_block(self):
        ...
        assert np.allclose(expected, in_arr)
...
class TestInterpolateGrid(unittest.TestCase):
    def test_interpolate_grid(self):
        ...
        assert np.allclose(result, in_arr)
