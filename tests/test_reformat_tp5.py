...
def main():
    ...
    with open("data/test-midlat-summer-trans.tp5", "w") as src:
        src.write(
            MIDLAT_SUMMER_TRANSMITTANCE.format(
                albedo=0.0,
                water=1.07000122070313,
                ozone=0.28499999642372,
                filter_function="landsat7_vsir.flt",
    ...
    with open("data/test-midlat-summer.tp5") as src:
    ...
    with open("data/test-midlat-summer-trans.tp5") as src:
