...
L1_TARBALL_PATH: Path = (
    Path(__file__).parent / "data" / "LC08_L1TP_090084_20160121_20170405_01_T1.tar.gz"
)
...
def test_prepare_l7_l1_usgs_tarball(tmpdir):
    ...
    expected_doc = {
        ...
        "extent": {
            ...
            "coord": {
                "ll": {"lat": -35.71162642627402, "lon": 148.5697851318128},
                "lr": {"lat": -35.648930411428125, "lon": 151.1887791534246},
                "ul": {"lat": -33.561627680748764, "lon": 148.52977968016268},
                "ur": {"lat": -33.503736851013535, "lon": 151.0823438821332},
            },
        },
        "format": {"name": "GeoTIFF"},
        "grid_spatial": {
            "projection": {
                "geo_ref_points": {
                    "ll": {"x": 642000.0, "y": -3953100.0},
                    "lr": {"x": 879300.0, "y": -3953100.0},
                    "ul": {"x": 642000.0, "y": -3714600.0},
                    "ur": {"x": 879300.0, "y": -3714600.0},
                },
        ...
        "image": {
            "bands": {
                ...
                "cirrus": {
                    "layer": 1,
                    "path": path_offset(
                        "LC08_L1TP_090084_20160121_20170405_01_T1_B9.TIF"
                    ),
                },
                "coastal_aerosol": {
                    "layer": 1,
                ...
                "lwir1": {
                    "layer": 1,
                    "path": path_offset(
                        "LC08_L1TP_090084_20160121_20170405_01_T1_B10.TIF"
                    ),
                },
                "lwir2": {
                    "layer": 1,
                    "path": path_offset(
                        "LC08_L1TP_090084_20160121_20170405_01_T1_B11.TIF"
                    ),
                },
                "nir": {
                    "layer": 1,
                    "path": path_offset(
                        "LC08_L1TP_090084_20160121_20170405_01_T1_B5.TIF"
                    ),
                },
                "panchromatic": {
                    "layer": 1,
                    "path": path_offset(
                        "LC08_L1TP_090084_20160121_20170405_01_T1_B8.TIF"
                    ),
                },
                "quality": {
                    "layer": 1,
                    "path": path_offset(
                        "LC08_L1TP_090084_20160121_20170405_01_T1_BQA.TIF"
                    ),
                },
                "red": {
                    "layer": 1,
                    "path": path_offset(
                        "LC08_L1TP_090084_20160121_20170405_01_T1_B4.TIF"
                    ),
                },
                "swir1": {
                    "layer": 1,
                    "path": path_offset(
                        "LC08_L1TP_090084_20160121_20170405_01_T1_B6.TIF"
                    ),
                },
                "swir2": {
                    "layer": 1,
                    "path": path_offset(
                        "LC08_L1TP_090084_20160121_20170405_01_T1_B7.TIF"
                    ),
                },
            },
        },
