...
L1GT_TARBALL_PATH: Path = (
    Path(__file__).parent / "data" / "LE07_L1GT_104078_20131209_20161119_01_T2.tar.gz"
)
...
def test_prepare_l1_tarball(tmpdir):
    ...
    res = CliRunner().invoke(
        ...
        ("--output", str(output_path), "--date", "3/12/2017", str(L1GT_TARBALL_PATH)),
        catch_exceptions=False,
    )
    assert res.exit_code == 0, res.output

    expected_metadata_path = (
        output_path / "LE07_L1GT_104078_20131209_20161119_01_T2.yaml"
    )
    ...
    def path_offset(offset: str):
        return "tar:" + str(L1GT_TARBALL_PATH.absolute()) + "!" + offset
        ...
        diff(
            doc,
            {
                ...
                "grid_spatial": {
                    "projection": {
                        "geo_ref_points": {
                            "ll": {"x": 522600.0, "y": -2981400.0},
                            "lr": {"x": 767700.0, "y": -2981400.0},
                            "ul": {"x": 522600.0, "y": -2768700.0},
                            "ur": {"x": 767700.0, "y": -2768700.0},
                        },
                ...
                "image": {
                    "bands": {
                        "blue": {
                            "layer": 1,
                            "path": path_offset(
                                "LE07_L1GT_104078_20131209_20161119_01_T2_B1.TIF"
                            ),
                        },
                        "green": {
                            "layer": 1,
                            "path": path_offset(
                                "LE07_L1GT_104078_20131209_20161119_01_T2_B2.TIF"
                            ),
                        },
                        "nir": {
                            "layer": 1,
                            "path": path_offset(
                                "LE07_L1GT_104078_20131209_20161119_01_T2_B4.TIF"
                            ),
                        },
                        "quality": {
                            "layer": 1,
                            "path": path_offset(
                                "LE07_L1GT_104078_20131209_20161119_01_T2_BQA.TIF"
                            ),
                        },
                        "red": {
                            "layer": 1,
                            "path": path_offset(
                                "LE07_L1GT_104078_20131209_20161119_01_T2_B3.TIF"
                            ),
                        },
                        "swir1": {
                            "layer": 1,
                            "path": path_offset(
                                "LE07_L1GT_104078_20131209_20161119_01_T2_B5.TIF"
                            ),
                        },
                        "swir2": {
                            "layer": 1,
                            "path": path_offset(
                                "LE07_L1GT_104078_20131209_20161119_01_T2_B7.TIF"
                            ),
                        },
                    }
                },
