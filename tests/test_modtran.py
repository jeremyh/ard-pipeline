...
from wagl.modtran import _get_solar_angles, coefficients
...
class ModtranTest(unittest.TestCase):
    ...
    def test_modtran_run(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            data = pd.read_csv(
                trans_file, nrows=nbands, header=None, delim_whitespace=True
            )
            ...
            nbar, _ = coefficients(
                chn_data, df_sz_angle, upward_radiation=None, downward_radiation=None
            )
