...
def test_prepare_l7_l1_usgs_tarball(tmpdir):
    ...
    expected_doc = {
        ...
        "extent": {
            ...
            "coord": {
                "ll": {"lat": -37.0505865085101, "lon": 148.05040048068},
                "lr": {"lat": -36.99521175837006, "lon": 150.77305358506374},
                "ul": {"lat": -35.07373601408718, "lon": 148.02444424678097},
                "ur": {"lat": -35.02220984451927, "lon": 150.68005778871884},
            },
        },
        "format": {"name": "GeoTIFF"},
        "grid_spatial": {
            "projection": {
                "geo_ref_points": {
                    "ll": {"x": 593400.0, "y": -4101000.0},
                    "lr": {"x": 835800.0, "y": -4101000.0},
                    "ul": {"x": 593400.0, "y": -3881700.0},
                    "ur": {"x": 835800.0, "y": -3881700.0},
                },
        ...
        "image": {
            "bands": {
                "blue": {
                    "layer": 1,
                    "path": path_offset(
                        "LT05_L1TP_090085_19970406_20161231_01_T1_B1.TIF"
                    ),
                },
                "green": {
                    "layer": 1,
                    "path": path_offset(
                        "LT05_L1TP_090085_19970406_20161231_01_T1_B2.TIF"
                    ),
                },
                "nir": {
                    "layer": 1,
                    "path": path_offset(
                        "LT05_L1TP_090085_19970406_20161231_01_T1_B4.TIF"
                    ),
                },
                "quality": {
                    "layer": 1,
                    "path": path_offset(
                        "LT05_L1TP_090085_19970406_20161231_01_T1_BQA.TIF"
                    ),
                },
                "red": {
                    "layer": 1,
                    "path": path_offset(
                        "LT05_L1TP_090085_19970406_20161231_01_T1_B3.TIF"
                    ),
                },
                "swir1": {
                    "layer": 1,
                    "path": path_offset(
                        "LT05_L1TP_090085_19970406_20161231_01_T1_B5.TIF"
                    ),
                },
                "swir2": {
                    "layer": 1,
                    "path": path_offset(
                        "LT05_L1TP_090085_19970406_20161231_01_T1_B7.TIF"
                    ),
                },
            },
        },
