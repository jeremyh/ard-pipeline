...
NCI_TEST_DATASETS = (
    ...
    # Failed repeatedly on old version
    "/g/data/fj7/Copernicus/Sentinel-2/MSI/L1C/2023/2023-05/40S140E-45S145E/S2B_MSIL1C_20230515T002059_N0509_R116_T55GCP_20230515T014126.zip",
...
NCI_FUQIN_S2_TEST_DATASETS = (
    # Fuqin's test scenes.
    "/g/data/fj7/Copernicus/Sentinel-2/MSI/L1C/2021/2021-12/30S140E-35S145E/S2A_MSIL1C_20211212T003701_N0301_R059_T54JWL_20211212T020702.zip",
    "/g/data/fj7/Copernicus/Sentinel-2/MSI/L1C/2022/2022-02/35S145E-40S150E/S2A_MSIL1C_20220218T000241_N0400_R030_T55HFA_20220218T012533.zip",
    "/g/data/fj7/Copernicus/Sentinel-2/MSI/L1C/2017/2017-12/30S140E-35S145E/S2B_MSIL1C_20171208T003659_N0206_R059_T54JWL_20171208T034537.zip",
    "/g/data/fj7/Copernicus/Sentinel-2/MSI/L1C/2021/2021-05/35S145E-40S150E/S2B_MSIL1C_20210522T001109_N0300_R073_T55HEV_20210522T012307.zip",
)
NCI_TEST_DATASETS = NCI_TEST_DATASETS + NCI_FUQIN_S2_TEST_DATASETS
...
def main(
    ...
    for dataset in datasets:
        ...
        try:
            optional_args = {}
            if (
                "clean_up_working_files"
                in inspect.signature(eugl_fmask.fmask).parameters
            ):
...
def cli():
    ...
    if args.test_data_eod3:
        eod3 = Path(
            os.getenv(
                "EODATASETS3_PATH",
                Path(__file__).resolve().parent.parent / "eo-datasets",
            )
        )
        if not eod3.exists():
            raise ValueError(
