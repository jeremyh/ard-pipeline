...
with prefix 'eugl-' and a version number following PEP-440.
...
def get_version():
    ...
    if isdir(git_dir):
        ...
        # (eg. "eugl-0.0.0-651-gcf335a9-dirty")
        cmd = [
            "git",
            "--git-dir",
            git_dir,
        ...
        try:
            version = pkg_resources.get_distribution("eugl").version
        except pkg_resources.DistributionNotFound:
            raise RuntimeError(
                "Unknown version: Package is not installed, not a "
