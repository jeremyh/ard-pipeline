...
def lndhdrread(filename):
    ...
    if Lnum >= 4 & Lnum <= 7:
        (
            Refmax,
            Refmin,
        ) = None  # LS8 variables only. The original MATLAB function returns all variables.
        ...
        Lmax_B6 = np.float32(data["RADIANCE_MAXIMUM_BAND_6"])
        Lmax_B7 = np.float32(data["RADIANCE_MAXIMUM_BAND_7"])
        np.float32(data["RADIANCE_MAXIMUM_BAND_9"])
        np.float32(data["RADIANCE_MAXIMUM_BAND_10"])
        ...
        Lmin_B6 = np.float32(data["RADIANCE_MINIMUM_BAND_6"])
        Lmin_B7 = np.float32(data["RADIANCE_MINIMUM_BAND_7"])
        np.float32(data["RADIANCE_MINIMUM_BAND_9"])
        np.float32(data["RADIANCE_MINIMUM_BAND_10"])
        ...
        Qcalmax_B6 = np.float32(data["QUANTIZE_CAL_MAX_BAND_6"])
        Qcalmax_B7 = np.float32(data["QUANTIZE_CAL_MAX_BAND_7"])
        np.float32(data["QUANTIZE_CAL_MAX_BAND_9"])
        np.float32(data["QUANTIZE_CAL_MAX_BAND_10"])
        ...
        Qcalmin_B6 = np.float32(data["QUANTIZE_CAL_MIN_BAND_6"])
        Qcalmin_B7 = np.float32(data["QUANTIZE_CAL_MIN_BAND_7"])
        np.float32(data["QUANTIZE_CAL_MIN_BAND_9"])
        np.float32(data["QUANTIZE_CAL_MIN_BAND_10"])
