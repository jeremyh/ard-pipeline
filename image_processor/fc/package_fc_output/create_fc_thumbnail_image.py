...
def process(subprocess_list=[], resume=False):
    ...
    rgb_files = [
        os.path.join(
            fc_temp_output, "scene01", fc_dataset_id + "_" + file_suffix + ".tif"
        )
        for file_suffix in ["BS", "PV", "NPV"]
    ]
    ...
    create_output_image(rgb_files, thumbnail_path, thumbnail_temp_dir, 1024)
