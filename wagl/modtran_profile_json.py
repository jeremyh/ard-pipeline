...
def midlat_winter_albedo(
    ...
    """MODTRAN 6.0.1 input: 'json' format template for mid latitude winter albedo."""
    _midlat_winter_albedo = {
        "MODTRAN": [
            {
                "MODTRANINPUT": {
                    "NAME": name,
                    ...
                    "ATMOSPHERE": {
                        "MODEL": "ATM_MIDLAT_WINTER",
                        "M1": "ATM_MIDLAT_WINTER",
                        "M2": "ATM_MIDLAT_WINTER",
                        "M3": "ATM_MIDLAT_WINTER",
                        "M4": "ATM_MIDLAT_WINTER",
                        "M5": "ATM_MIDLAT_WINTER",
                        "M6": "ATM_MIDLAT_WINTER",
                        "MDEF": 1,
                        "CO2MX": 375.0,
                        "H2OSTR": water,
                        "H2OUNIT": "G",
    ...
    return _midlat_winter_albedo


def subarctic_summer_albedo(
    name,
    water,
    ozone,
    visibility,
    ...
    """MODTRAN 6.0.1 input: 'json' format template for subarctic summer albedo."""
    _subarctic_summer_albedo = {
        "MODTRAN": [
            {
                "MODTRANINPUT": {
                    "NAME": name,
                    ...
                    "ATMOSPHERE": {
                        "MODEL": "ATM_SUBARC_SUMMER",
                        "M1": "ATM_SUBARC_SUMMER",
                        "M2": "ATM_SUBARC_SUMMER",
                        "M3": "ATM_SUBARC_SUMMER",
                        "M4": "ATM_SUBARC_SUMMER",
                        "M5": "ATM_SUBARC_SUMMER",
                        "M6": "ATM_SUBARC_SUMMER",
                        "MDEF": 1,
                        "CO2MX": 375.0,
                        "H2OSTR": water,
                        "H2OUNIT": "G",
    ...
    return _subarctic_summer_albedo


def subarctic_winter_albedo(
    name,
    water,
    ozone,
    visibility,
    ...
    """MODTRAN 6.0.1 input: 'json' format template for subarctic winter albedo."""
    _subarctic_winter_albedo = {
        "MODTRAN": [
            {
                "MODTRANINPUT": {
                    "NAME": name,
                    ...
                    "ATMOSPHERE": {
                        "MODEL": "ATM_SUBARC_WINTER",
                        "M1": "ATM_SUBARC_WINTER",
                        "M2": "ATM_SUBARC_WINTER",
                        "M3": "ATM_SUBARC_WINTER",
                        "M4": "ATM_SUBARC_WINTER",
                        "M5": "ATM_SUBARC_WINTER",
                        "M6": "ATM_SUBARC_WINTER",
                        "MDEF": 1,
                        "CO2MX": 375.0,
                        "H2OSTR": water,
                        "H2OUNIT": "G",
    ...
    return _subarctic_winter_albedo


def us_standard_1976_albedo(
    name,
    water,
    ozone,
    visibility,
    ...
    """MODTRAN 6.0.1 input: 'json' format template for US standard 1976 albedo."""
    _us_standard_1976_albedo = {
        "MODTRAN": [
            {
                "MODTRANINPUT": {
                    "NAME": name,
                    ...
                    "ATMOSPHERE": {
                        ...
                        "M1": "ATM_US_STANDARD_1976",
                        "M2": "ATM_US_STANDARD_1976",
                        "M3": "ATM_US_STANDARD_1976",
                        "M4": "ATM_US_STANDARD_1976",
                        "M5": "ATM_US_STANDARD_1976",
                        "M6": "ATM_US_STANDARD_1976",
                        "MDEF": 1,
                        "CO2MX": 375.0,
                        "H2OSTR": water,
                        "H2OUNIT": "G",
    ...
    return _us_standard_1976_albedo
