...
def read_task_db(fname):
    ...
    tasks = pd.read_sql_query("SELECT * from tasks", connection)
    events = pd.read_sql_query("SELECT * from task_events", connection)
    params = pd.read_sql_query("SELECT * from task_parameters", connection)
