...
def prepare_dataset(path):
    ...
    degraded_anc_data_percentage = root_datastrip.findall(
        ".//*/DEGRADED_ANC_DATA_PERCENTAGE"
    )[0].text
    degraded_msi_data_percentage = root.findall(".//*/DEGRADED_MSI_DATA_PERCENTAGE")[
        0
    ].text
    ...
    sun_azimuth_angle = root.findall("./*/Tile_Angles/Mean_Sun_Angle/AZIMUTH_ANGLE")[
        0
    ].text
    ...
    img_dict = {}
    for image in images:
        img_path = f"s3://{SRC_BUCKET}/{tile_path}/{image}"
