...
pip install --user 'cligj==0.7.2' 'itsdangerous==2.0.1' 'mpi-structlog==0.0.1' 'nested-lookup==0.2.23' 'python-rapidjson==1.6' 'requests-cache==0.7.5' 'rios==1.4.10' 'tenacity==6.3.1' 'url-normalize==1.4.3'
