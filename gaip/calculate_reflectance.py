...
def _calculate_reflectance(
    ...
    with h5py.File(bilinear_fname, "r") as fid_bil, h5py.File(
...
def calculate_reflectance(
    ...
    dif_dataset,
    ts_dataset,
    solar_zenith_dataset,
    solar_azimuth_dataset,
    satellite_view_dataset,
    relative_angle_dataset,
    slope_dataset,
    aspect_dataset,
    relative_slope_dataset,
    incident_angle_dataset,
    exiting_angle_dataset,
    self_shadow_dataset,
    cast_shadow_sun_dataset,
    cast_shadow_satellite_dataset,
    rori,
    brdf_iso,
    brdf_vol,
    brdf_geo,
    ...
    for tile in tiles:
        ...
        cast_shadow_satellite = as_array(cast_shadow_satellite_dataset[idx], **i16_args)
