...
class Band:
    ...
    def __init__(
        ...
        desc="Band 1",
        resolution_M=25.0,
        band_type=BandType.REF,
        wavelength_nm=[0.5, 0.6],
        other_props={},
    ):
    ...
    def __str__(self):
        return "{}, {} ({}) {}".format(
            self.id, self.desc, self.band_type.name, str(self.wavelength_nm)
        )

    def __repr__(self):
        return f"Band: {str(self)}"
...
class Sensor:
    ...
    def __init__(self, id="ID", desc="A sensor", bands=[], other_props={}):
        self.id = id
        self.desc = desc
        self.bands = bands
        self.__dict__.update(other_props)
...
class Spacecraft(Enum):
    ...
    LS5 = (
        [  # sensors \
            ...
            Sensor(
                ...
                other_props={"K1": 607.76, "K2": 1260.56, "acquisition_seconds": 24},
            ),
        ],
    ...
    LS7 = (
        [  # sensors \
            Sensor(
                ...
                other_props={"K1": 666.09, "K2": 1282.71, "acquisition_seconds": 24},
            )
        ],
        {  # other spacecraft properties \
            "altitude": 705000.0,
        ...
        [  # sensors \
            Sensor(
                ...
                bands=[
                    ...
                    Band(
                        "6", "Short-wave Infrared 1", 25.0, BandType.REF, [1.56, 1.66]
                    ),
                ...
                other_props={"K1": 0, "K2": 0, "acquisition_seconds": 24},
            ),
            Sensor(
                "TIRS",
                ...
                other_props={"K1": 774.89, "K2": 1321.08, "acquisition_seconds": 24},
            ),
    ...
    def __repr__(self):
        return f"{self} (Sensors: {self.sensors.keys()})"
