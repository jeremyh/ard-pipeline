...
class TestLandSea(unittest.TestCase):
    def test_flinders_islet(self):
        ...
        # print mask.shape
        assert total_pixels == 17 * 19
        assert land_pixels == 182
        assert sea_pixels == 141
        # print mask
    ...
    def test_whole_AGDC_cell_no_sea(self):
        ...
        # print mask.shape
        assert total_pixels == 4000 * 4000
        assert land_pixels == 4000 * 4000
        assert sea_pixels == 0
        # print mask
    ...
    def test_whole_AGDC_cell_land_and_sea(self):
        ...
        # print mask.shape
        assert total_pixels == 4000 * 4000
        assert land_pixels == 6920586
        assert sea_pixels == 9079414
        # print mask
    ...
    def test_l1t_scene(self):
        ...
        with rasterio.open(p) as ds:
            ...
            assert mask.shape == (8801, 9041)

            total_pixels = mask.shape[0] * mask.shape[1]
            land_pixels = sum(sum(mask.astype("uint32")))
            sea_pixels = total_pixels - land_pixels

            assert total_pixels == 8801 * 9041
            assert land_pixels == 76137796
            assert sea_pixels == 3432045
            # print mask
