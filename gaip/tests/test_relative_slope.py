...
from gaip import acquisitions, find_file, read_img, relative_azimuth_slope
...
def compute_relative_azimuth_slope(ref_dir, outdir):
    ...
    relative_azimuth_slope(
        fname_azimuth_incident, fname_azimuth_exiting, relative_azimuth_slope_out_fname
    )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=("Perform unittesting for " "the relative azimuth " "slope angles.")
    )
