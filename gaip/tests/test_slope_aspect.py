...
from gaip import acquisitions, find_file, read_img, slope_aspect_arrays
...
def compute_slope_aspect(acquisition, ref_dir, out_dir, margins):
    ...
    slope_aspect_arrays(
        acquisition, dsm_fname, margins, slope_out_fname, aspect_out_fname
    )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=("Perform unittesting for " "the slope and aspect " "angle arrays.")
    )
    ...
    parser.add_argument(
        ...
        default=250,
        help=(
            "The buffer in pixels to be used in calculating "
