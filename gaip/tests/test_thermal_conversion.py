...
class MockDataset:
    def __init__(self):
        ...
        self.gain = {
            1: 0.7658267716535433,
            2: 1.4481889763779527,
            3: 1.043976377952756,
            4: 0.876023622047244,
            5: 0.12035433070866142,
            6: 0.0553740157480315,
            7: 0.0655511811023622,
        }
        self.bias = {
            1: -2.2858267716535465,
            2: -4.288188976377967,
            3: -2.213976377952804,
            4: -2.386023622047219,
            5: -0.4903543307086622,
            6: 1.1826259842519669,
...
class TestThermalConversion(unittest.TestCase):
    ...
    def test_conversion(self):
        ...
        l1t_data = np.array([b1, b1, b1, b1, b1, b1, b1])
