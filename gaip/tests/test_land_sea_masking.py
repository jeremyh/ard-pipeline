...
class TestLandSea(unittest.TestCase):
    def no_test_L8(self):
        ...
        assert land_pixels == 75976737
        assert sea_pixels == 9393744
        assert total_pixels == 85370481
    ...
    def no_test_agdc_cell(self):
        ...
        (shape[1] * scale + 150, -34 - shape[0] * scale)
        ...
        assert land_pixels == 14554858
        assert sea_pixels == 1445142
        assert total_pixels == 16000000
