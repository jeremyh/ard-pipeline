...
from gaip import acquisitions, calculate_self_shadow, find_file, read_img
...
class TestSelfShadowSlopeOutputs(ParameterisedTestCase):
    ...
    * relative_slope.bin.
    ...
    def test_self_shadow_mask(self):
        ...
        assert npt.assert_allclose(test_img, ref_img, atol=int_prec) is None
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Perform unittesting for the self shadow and various slope angles."
    )
